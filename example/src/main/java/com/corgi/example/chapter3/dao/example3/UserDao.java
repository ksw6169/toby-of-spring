...
import com.corgi.example.chapter3.dao.example3.statement.AddStatement;
import com.corgi.example.chapter3.dao.example3.statement.DeleteAllStatement;
import com.corgi.example.chapter3.dao.example3.statement.StatementStrategy;
...
@Repository(value = "exampleUserDao3")
